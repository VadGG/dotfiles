...
local mappings = {
  ...
  p = {
    ...
    u = { "<cmd>Telescope neoclip unnamed<CR>", "Unnamed Clipboard History" },
    ['*'] = { "<cmd>Telescope neoclip star<CR>", "* Clipboard History" },
    ['+'] = { "<cmd>Telescope neoclip plus<CR>", "+ Clipboard History" },
    t = { "<cmd>lua require('neoclip').toggle()<CR>", "On/Off NeoClip recording" },
  },

  b = {
    name = "Buffer",
    x = { "<cmd>lua MiniBufremove.delete()<cr>", "Close Buffer" },
    s = { "<cmd>%bd|e#|bd#<CR>", "Solo Buffer" },
  },

  w = {
    name = "Window",
    s = { "<cmd>w<CR>", "Save Current" },
    S = { "<cmd>wal!<CR>", "Save All" },
    q = { "<cmd>q<CR>", "Quit Current" },
    Q = { "<cmd>qal!<CR>", "Quit All" },
  },
